...
dependencies {
    ...
    implementation("io.ktor:ktor-server-netty:$ktorVersion") // Using netty as a server engine
    ...
    implementation("io.ktor:ktor-jackson:$ktorVersion") // Added for serialization purposes
    implementation("com.fasterxml.jackson.datatype:jackson-datatype-joda")
    implementation("io.ktor:ktor-html-builder:$ktorVersion") // Added for building webpages
    implementation("io.ktor:ktor-freemarker:$ktorVersion") //       Using Apache FreeMarker
